...
msgSubscriber = ".me If you want to support the channel and get access to our sub only emotes buddhaCrash buddhaLove buddhaPineapple buddhaHi buddhaLean buddhaSellout buddhaCry buddhaLUL buddhaPray you can subscribe at https://www.twitch.tv/thebuddha3/subscribe <3"
...
#SUB NOTIFICATION
    if "room-id=136765278" and "msg-param-sub-plan-name=Channel\sSubscription\s(thebuddha3)" and "tmi.twitch.tv USERNOTICE"in message:
        ...
        if submonths == "1":
        #    irc.send('PRIVMSG ' + channel + ' :' +"Horry Shit Madda Fakka! buddhaPineapple buddhaLove Thanks for subbing " + subname + "! buddhaHi Keep on leaning! buddhaLean Make sure to refresh and share. Sub Spam that buddhaLove for our newest sub!" + '\r\n')
            ...
            #irc.send('PRIVMSG ' + channel + ' :' +"Horry Shit Madda Fakka!" + subname + "with the buddhaPineapple buddhaLove Thanks for keeping that sub alive " + subscriber + "! buddhaHi Keep on leaning!  Sub Spam that buddhaLove for our newest sub!" + '\r\n')
            irc.send('PRIVMSG ' + channel + ' :' + subname + " ust resubscribed for " + submonths + "months. Thanks for staying loyal to Buddha's Dojo buddhaHi Spam some love in the chat! buddhaLove" + '\r\n')
